...
TOKEN_CATALOGUE = {
    ...
    "LWN": "Last wicket — dismissed batter's name (text)",
    "LWS": "Last wicket batter's score, 'runs (balls)' e.g. '60 (39)'",
    "LWD": "Last wicket decision (b/lbw/c/ro/hw/ht/to/of/rt/st)",
    "LWB": "Last wicket — incoming (new) batter's name (text)",
    "LWF": "Last wicket — fielder's name (text)",
